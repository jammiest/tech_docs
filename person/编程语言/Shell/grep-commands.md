...
![grep收缩返回状态](./figures/Grep.搜索返回状态.png)
...
![Grep.查看系统进程01.png](./figures/Grep.查看系统进程01.png)
...
![Grep.查看系统进程02.png](./figures/Grep.查看系统进程02.png)
...
![Grep.查看系统进程03.png](./figures/Grep.查看系统进程03.png)
...
![Grep.从文件中读取关键词进行搜索.png](./figures/Grep.从文件中读取关键词进行搜索.png)

### 从文件中读取关键词进行搜索 且显示行号

![Grep.从文件中读取关键词进行搜索且显示行号.png](./figures/Grep.从文件中读取关键词进行搜索且显示行号.png)
...
![Grep.从文件中查找关键词.png](./figures/Grep.从文件中查找关键词.png)
...
![Grep.从多个文件中查找关键词.png](./figures/Grep.从多个文件中查找关键词.png)
